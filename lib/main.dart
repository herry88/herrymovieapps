...
//import 'model/watchlist_manager.dart';
import './ui/search_screen.dart';
import './ui/watched_screen.dart';
import './ui/genre_screen.dart';
import './ui/upcoming_movies.dart';
          ...
          showDialog(context: context, builder: (BuildContext context) => new AboutDialog(
            ...
            children: <Widget>[
              new RaisedButton(onPressed: () async {
                if(await canLaunch("https://github.com/herry88/herrymovieapps"))
                  launch("https://github.com/herry88/herrymovieapps");
                   },
